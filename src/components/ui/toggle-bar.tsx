    ...
    <div className="rounded-lg bg-white shadow-card dark:bg-light-dark">
      <div className="relative flex items-center justify-between gap-4 p-4">
        <div className="flex items-center mr-6">
          {icon && (
            <div className="flex h-10 w-10 shrink-0 items-center justify-center rounded-full bg-gray-100 text-gray-900 mr-2 dark:bg-gray-600 dark:text-gray-400">
              {icon}
            </div>
          )}
          <div>
            ...
            <span
              className={cn(
                checked
                  ...
                  : "bg-white translate-x-0.5 dark:bg-gray-400",
