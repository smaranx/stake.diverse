  ...
  return (
    <div className="flex flex-grow">
      <div className="mx-auto flex w-full flex-grow flex-col transition-all xl:max-w-[1360px] 4xl:max-w-[1760px]">
        <div className="relative mb-5 flex flex-grow items-center justify-center md:pb-7 md:pt-4 md:left-0 md:pl-6 lg:fixed lg:mb-0 lg:h-[calc(100%-96px)] lg:w-[calc(100%-492px)] lg:pl-8 xl:w-[calc(100%-550px)] xl:pr-12 xl:pl-[340px] 2xl:pl-96 3xl:w-[calc(100%-632px)] 4xl:pl-0">
          ...
          <div className="block">
            <div className="block">
              <div className="flex justify-between">
                ...
                <div className="mt-1.5 shrink-0 ml-3 xl:mt-2">
                  <NftDropDown />
                </div>
              </div>
              <AnchorLink
              ...
              >
                ...
                <ArrowLinkIcon className="h-3 w-3 ml-2" />
              </AnchorLink>
              <div className="mt-4 flex flex-wrap gap-6 pt-0.5 lg:-mx-6 lg:mt-6 lg:gap-0">
                <div className="shrink-0 border-dashed border-gray-200 dark:border-gray-700 lg:px-6 lg:border-r">
