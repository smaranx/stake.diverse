  ...
  return (
    <div className="relative">
      <Menu>
        ...
        >
          <Menu.Items className="absolute z-20 mt-5 w-60 origin-top-right rounded-lg bg-white py-3 shadow-large right-0 dark:bg-gray-800">
            <div className="px-3">
              <Menu.Item>
                <AnchorLink
                  href="/"
                ...
                >
                  Place floor bid
                  <span className="inline-flex rounded-md bg-[#FF445C] px-2 py-1 text-xs text-white ml-2">
                    new
                  </span>
                </AnchorLink>
              </Menu.Item>
