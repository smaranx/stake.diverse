    ...
    >
      ...
      >
        ...
        {["active", "off-chain"].indexOf(vote.status) !== -1 && (
          <div className="before:content-[' '] relative mb-5 grid h-full gap-2 pb-5 before:absolute before:bottom-0 before:h-[1px] before:w-full before:border-b before:border-r before:border-dashed before:border-gray-200 before:left-0 dark:border-gray-700 dark:before:border-gray-700 xs:gap-2.5 md:mb-0 md:pb-0 md:before:h-full md:before:w-[1px] md:pl-8">
            ...
            >
              ...
              >
                <span
                  className={cn(
                    isExpand
                      ? "bg-white translate-x-5 dark:bg-gray-700"
                      : "bg-white translate-x-0.5 dark:bg-gray-200",
